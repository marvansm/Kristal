  ...
  return (
    <div className="box">
      <div className="boxImg">
        <img
          src="https://kristal.az/site/assets/files/1190/asset_205-min.png"
          alt=""
        />
      </div>
      <div className="boxBody px-[35px] py-[25px] bg-white rounded-b-[25px]">
        <h2 className="text-[25px] text-[#2C2929] font-medium">
          Kristal Towers
        </h2>
        <h3 className="flex items-center gap-1">
          ...
          />
          <span className="opacity-[0.6]">Bakı bulvarı</span>
        </h3>
        <ul className="mt-[28px] flex items-start justify-between">
          ...
          <li className="text-[#2C2929] text-[25px] font-medium flex items-end flex-col">
            297 280$ <span className="text-[#2C2929] text-[16px] font-normal opacity-[0.6]">başlayaraq</span>
          </li>
        </ul>
      </div>
    </div>
